...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-2 z-50 bg-gradient-to-r from-[#EEF2FF] via-[#F5F8FF] to-[#FFF5F9] shadow-md py-2 rounded-full mx-auto mt-4 max-w-[1200px] px-4 sm:px-6 lg:px-8">
    ...
    <div className="flex items-center gap-8">
      ...
      <div className="flex-shrink-0">
        <Link href="/" className="flex items-center">
          <Image src="/logo.png" alt="BrandNav" width={150} height={60} />
        </Link>
      </div>
